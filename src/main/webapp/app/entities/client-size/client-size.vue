<template>
  <div>
    <h2 id="page-heading" data-cy="ClientSizeHeading">
      <span v-text="t$('sdiApp.clientSize.home.title')" id="client-size-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sdiApp.clientSize.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ClientSizeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiApp.clientSize.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clientSizes && clientSizes.length === 0">
      <span v-text="t$('sdiApp.clientSize.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clientSizes">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiApp.clientSize.sizeName')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientSize.sizeCode')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientSize.sizeDescription')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientSize.creaDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientSize.updateDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientSize.notes')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="sdiApp.clientSize.delete.question" data-cy="clientSizeDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-clientSize-heading" v-text="t$('sdiApp.clientSize.delete.question', { id: removeId })"></p>
      </div>
