<template>
  <div>
    <h2 id="page-heading" data-cy="ProductLineHeading">
      <span v-text="t$('sdiApp.productLine.home.title')" id="product-line-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sdiApp.productLine.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ProductLineCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiApp.productLine.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && productLines && productLines.length === 0">
      <span v-text="t$('sdiApp.productLine.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="productLines">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiApp.productLine.name')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.productLine.notes')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.productLine.creaDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.productLine.updateDate')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="sdiApp.productLine.delete.question" data-cy="productLineDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-productLine-heading" v-text="t$('sdiApp.productLine.delete.question', { id: removeId })"></p>
      </div>
