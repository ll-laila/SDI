      ...
      if (this.clientEvent.id) {
        this.clientEventService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('sdiApp.clientEvent.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.clientEventService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('sdiApp.clientEvent.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
