<template>
  <div>
    <h2 id="page-heading" data-cy="DomaineHeading">
      <span v-text="t$('sdiApp.domaine.home.title')" id="domaine-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sdiApp.domaine.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'DomaineCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiApp.domaine.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && domaines && domaines.length === 0">
      <span v-text="t$('sdiApp.domaine.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="domaines">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiApp.domaine.name')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.domaine.code')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.domaine.creaDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.domaine.updateDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.domaine.notes')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="sdiApp.domaine.delete.question" data-cy="domaineDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-domaine-heading" v-text="t$('sdiApp.domaine.delete.question', { id: removeId })"></p>
      </div>
