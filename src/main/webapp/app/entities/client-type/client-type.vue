<template>
  <div>
    <h2 id="page-heading" data-cy="ClientTypeHeading">
      <span v-text="t$('sdiApp.clientType.home.title')" id="client-type-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sdiApp.clientType.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ClientTypeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiApp.clientType.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clientTypes && clientTypes.length === 0">
      <span v-text="t$('sdiApp.clientType.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clientTypes">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiApp.clientType.type')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientType.description')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientType.creaDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientType.updateDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientType.notes')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="sdiApp.clientType.delete.question" data-cy="clientTypeDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-clientType-heading" v-text="t$('sdiApp.clientType.delete.question', { id: removeId })"></p>
      </div>
