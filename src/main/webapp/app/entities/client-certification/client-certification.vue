<template>
  <div>
    <h2 id="page-heading" data-cy="ClientCertificationHeading">
      <span v-text="t$('sdiApp.clientCertification.home.title')" id="client-certification-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sdiApp.clientCertification.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ClientCertificationCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiApp.clientCertification.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clientCertifications && clientCertifications.length === 0">
      <span v-text="t$('sdiApp.clientCertification.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clientCertifications">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.certification')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.certificationDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.creaDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.updateDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.notes')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.client')"></span></th>
            <th scope="row"><span v-text="t$('sdiApp.clientCertification.certif')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="clientCertification in clientCertifications" :key="clientCertification.id" data-cy="entityTable">
            ...
            <td>{{ clientCertification.creaDate }}</td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="sdiApp.clientCertification.delete.question"
          data-cy="clientCertificationDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-clientCertification-heading" v-text="t$('sdiApp.clientCertification.delete.question', { id: removeId })"></p>
      </div>
