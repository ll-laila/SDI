...
public class ProductDeployementResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<ProductDeployement> createProductDeployement(@RequestBody ProductDeployement productDeployement)
    ...
    public ResponseEntity<ProductDeployement> updateProductDeployement(
        ...
        @RequestBody ProductDeployement productDeployement
    ) throws URISyntaxException {
    ...
    public ResponseEntity<ProductDeployement> partialUpdateProductDeployement(
        ...
        Optional<ProductDeployement> result = productDeployementRepository
            ...
            .map(existingProductDeployement -> {
                if (productDeployement.getCode() != null) {
                    existingProductDeployement.setCode(productDeployement.getCode());
                }
                if (productDeployement.getRefContract() != null) {
                    existingProductDeployement.setRefContract(productDeployement.getRefContract());
                }
                if (productDeployement.getStartDeployementDate() != null) {
                    existingProductDeployement.setStartDeployementDate(productDeployement.getStartDeployementDate());
                }
                if (productDeployement.getEndDeployementDate() != null) {
                    existingProductDeployement.setEndDeployementDate(productDeployement.getEndDeployementDate());
                }
                if (productDeployement.getCreaDate() != null) {
                    existingProductDeployement.setCreaDate(productDeployement.getCreaDate());
                }
