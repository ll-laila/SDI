    ...
    public ResponseEntity<ClientEvent> partialUpdateClientEvent(
        ...
        Optional<ClientEvent> result = clientEventRepository
            ...
            .map(existingClientEvent -> {
                ...
                if (clientEvent.getCreaDate() != null) {
                    existingClientEvent.setCreaDate(clientEvent.getCreaDate());
                }
                if (clientEvent.getUpdateDate() != null) {
                    existingClientEvent.setUpdateDate(clientEvent.getUpdateDate());
                }
