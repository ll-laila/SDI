...
public class ModuleResource {
    ...
    public ResponseEntity<Module> partialUpdateModule(
        ...
        Optional<Module> result = moduleRepository
            ...
            .map(existingModule -> {
                ...
                if (module.getCreaDate() != null) {
                    existingModule.setCreaDate(module.getCreaDate());
                }
                if (module.getUpdateDate() != null) {
                    existingModule.setUpdateDate(module.getUpdateDate());
                }
                if (module.getNotes() != null) {
                    existingModule.setNotes(module.getNotes());
                }
     ...
     */
    @GetMapping("")
    public List<Module> getAllModules(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
