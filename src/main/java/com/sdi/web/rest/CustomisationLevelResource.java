...
public class CustomisationLevelResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<CustomisationLevel> createCustomisationLevel(@RequestBody CustomisationLevel customisationLevel)
    ...
    public ResponseEntity<CustomisationLevel> updateCustomisationLevel(
        ...
        @RequestBody CustomisationLevel customisationLevel
    ) throws URISyntaxException {
    ...
    public ResponseEntity<CustomisationLevel> partialUpdateCustomisationLevel(
        ...
        Optional<CustomisationLevel> result = customisationLevelRepository
            ...
            .map(existingCustomisationLevel -> {
                ...
                if (customisationLevel.getCreaDate() != null) {
                    existingCustomisationLevel.setCreaDate(customisationLevel.getCreaDate());
                }
