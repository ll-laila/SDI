...
public class FeatureDeployementResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<FeatureDeployement> createFeatureDeployement(@RequestBody FeatureDeployement featureDeployement)
    ...
    public ResponseEntity<FeatureDeployement> updateFeatureDeployement(
        ...
        @RequestBody FeatureDeployement featureDeployement
    ) throws URISyntaxException {
    ...
    public ResponseEntity<FeatureDeployement> partialUpdateFeatureDeployement(
        ...
        Optional<FeatureDeployement> result = featureDeployementRepository
            ...
            .map(existingFeatureDeployement -> {
                ...
                if (featureDeployement.getCustomisationDescription() != null) {
                    existingFeatureDeployement.setCustomisationDescription(featureDeployement.getCustomisationDescription());
                }
                if (featureDeployement.getCreaDate() != null) {
                    existingFeatureDeployement.setCreaDate(featureDeployement.getCreaDate());
                }
