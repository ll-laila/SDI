...
public class ClientCertificationResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<ClientCertification> createClientCertification(@RequestBody ClientCertification clientCertification)
    ...
    public ResponseEntity<ClientCertification> updateClientCertification(
        ...
        @RequestBody ClientCertification clientCertification
    ) throws URISyntaxException {
    ...
    public ResponseEntity<ClientCertification> partialUpdateClientCertification(
        ...
        Optional<ClientCertification> result = clientCertificationRepository
            ...
            .map(existingClientCertification -> {
                ...
                if (clientCertification.getCreaDate() != null) {
                    existingClientCertification.setCreaDate(clientCertification.getCreaDate());
                }
