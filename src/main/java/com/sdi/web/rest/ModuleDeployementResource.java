...
public class ModuleDeployementResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<ModuleDeployement> createModuleDeployement(@RequestBody ModuleDeployement moduleDeployement)
    ...
    public ResponseEntity<ModuleDeployement> updateModuleDeployement(
        ...
        @RequestBody ModuleDeployement moduleDeployement
    ) throws URISyntaxException {
    ...
    public ResponseEntity<ModuleDeployement> partialUpdateModuleDeployement(
        ...
        Optional<ModuleDeployement> result = moduleDeployementRepository
            ...
            .map(existingModuleDeployement -> {
                if (moduleDeployement.getCustomisationDescription() != null) {
                    existingModuleDeployement.setCustomisationDescription(moduleDeployement.getCustomisationDescription());
                }
                if (moduleDeployement.getCreaDate() != null) {
                    existingModuleDeployement.setCreaDate(moduleDeployement.getCreaDate());
                }
