...
public class ClientCriteria implements Serializable, Criteria {
    ...
    private LocalDateFilter creaDate;
    ...
    public ClientCriteria(ClientCriteria other) {
        ...
        this.creaDate = other.optionalCreaDate().map(LocalDateFilter::copy).orElse(null);
    ...
    public LocalDateFilter getCreaDate() {
        return creaDate;
    }

    public Optional<LocalDateFilter> optionalCreaDate() {
        return Optional.ofNullable(creaDate);
    }

    public LocalDateFilter creaDate() {
        if (creaDate == null) {
            setCreaDate(new LocalDateFilter());
        }
        return creaDate;
    }

    public void setCreaDate(LocalDateFilter creaDate) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(creaDate, that.creaDate) &&
    ...
    public String toString() {
        return "ClientCriteria{" +
            ...
            optionalCreaDate().map(f -> "creaDate=" + f + ", ").orElse("") +
