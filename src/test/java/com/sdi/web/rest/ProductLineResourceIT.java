...
class ProductLineResourceIT {
    ...
    public static ProductLine createEntity() {
        return new ProductLine().name(DEFAULT_NAME).notes(DEFAULT_NOTES).creaDate(DEFAULT_CREA_DATE).updateDate(DEFAULT_UPDATE_DATE);
    }
    ...
    public static ProductLine createUpdatedEntity() {
        return new ProductLine().name(UPDATED_NAME).notes(UPDATED_NOTES).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE);
    }
    ...
    void putExistingProductLine() throws Exception {
        ...
        updatedProductLine.name(UPDATED_NAME).notes(UPDATED_NOTES).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE);
    ...
    void partialUpdateProductLineWithPatch() throws Exception {
        ...
        partialUpdatedProductLine.name(UPDATED_NAME).notes(UPDATED_NOTES).creaDate(UPDATED_CREA_DATE);
    ...
    void fullUpdateProductLineWithPatch() throws Exception {
        ...
        partialUpdatedProductLine.name(UPDATED_NAME).notes(UPDATED_NOTES).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE);
