...
class DeployementTypeResourceIT {
    ...
    public static DeployementType createEntity() {
        return new DeployementType().type(DEFAULT_TYPE).creaDate(DEFAULT_CREA_DATE).updateDate(DEFAULT_UPDATE_DATE).notes(DEFAULT_NOTES);
    }
    ...
    public static DeployementType createUpdatedEntity() {
        return new DeployementType().type(UPDATED_TYPE).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
    }
    ...
    void putExistingDeployementType() throws Exception {
        ...
        updatedDeployementType.type(UPDATED_TYPE).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
    ...
    void fullUpdateDeployementTypeWithPatch() throws Exception {
        ...
        partialUpdatedDeployementType.type(UPDATED_TYPE).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
