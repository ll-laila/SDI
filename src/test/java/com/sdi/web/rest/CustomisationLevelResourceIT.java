...
class CustomisationLevelResourceIT {
    ...
    void putExistingCustomisationLevel() throws Exception {
        ...
        updatedCustomisationLevel.level(UPDATED_LEVEL).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
    ...
    void partialUpdateCustomisationLevelWithPatch() throws Exception {
        ...
        partialUpdatedCustomisationLevel.level(UPDATED_LEVEL);
