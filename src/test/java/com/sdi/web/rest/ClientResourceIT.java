...
class ClientResourceIT {
    ...
    private static final String DEFAULT_MAIN_CONTACT_EMAIL = "fIu:|a@DY6<Cc.TLf+";
    private static final String UPDATED_MAIN_CONTACT_EMAIL = "w['fZW@o.2zvfm*";
    ...
    private static final LocalDate SMALLER_CREA_DATE = LocalDate.ofEpochDay(-1L);
    ...
    @Test
    @Transactional
    void getAllClientsByCreaDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate equals to
        defaultClientFiltering("creaDate.equals=" + DEFAULT_CREA_DATE, "creaDate.equals=" + UPDATED_CREA_DATE);
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate in
        defaultClientFiltering("creaDate.in=" + DEFAULT_CREA_DATE + "," + UPDATED_CREA_DATE, "creaDate.in=" + UPDATED_CREA_DATE);
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate is not null
        defaultClientFiltering("creaDate.specified=true", "creaDate.specified=false");
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate is greater than or equal to
        defaultClientFiltering("creaDate.greaterThanOrEqual=" + DEFAULT_CREA_DATE, "creaDate.greaterThanOrEqual=" + UPDATED_CREA_DATE);
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate is less than or equal to
        defaultClientFiltering("creaDate.lessThanOrEqual=" + DEFAULT_CREA_DATE, "creaDate.lessThanOrEqual=" + SMALLER_CREA_DATE);
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate is less than
        defaultClientFiltering("creaDate.lessThan=" + UPDATED_CREA_DATE, "creaDate.lessThan=" + DEFAULT_CREA_DATE);
    }

    @Test
    @Transactional
    void getAllClientsByCreaDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where creaDate is greater than
        defaultClientFiltering("creaDate.greaterThan=" + SMALLER_CREA_DATE, "creaDate.greaterThan=" + DEFAULT_CREA_DATE);
    }
