...
class HAResourceIT {
    ...
    public static HA createEntity() {
        return new HA().name(DEFAULT_NAME).creaDate(DEFAULT_CREA_DATE).updateDate(DEFAULT_UPDATE_DATE).notes(DEFAULT_NOTES);
    }
    ...
    public static HA createUpdatedEntity() {
        return new HA().name(UPDATED_NAME).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
    }
    ...
    void putExistingHA() throws Exception {
        ...
        em.detach(updatedHA);
        updatedHA.name(UPDATED_NAME).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
    ...
    void partialUpdateHAWithPatch() throws Exception {
        ...
        partialUpdatedHA.creaDate(UPDATED_CREA_DATE).notes(UPDATED_NOTES);
    ...
    void fullUpdateHAWithPatch() throws Exception {
        ...
        partialUpdatedHA.name(UPDATED_NAME).creaDate(UPDATED_CREA_DATE).updateDate(UPDATED_UPDATE_DATE).notes(UPDATED_NOTES);
