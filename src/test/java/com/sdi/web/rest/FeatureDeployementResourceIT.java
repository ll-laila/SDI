...
class FeatureDeployementResourceIT {
    ...
    private static final String DEFAULT_CUSTOMISATION_DESCRIPTION = "AAAAAAAAAA";
    private static final String UPDATED_CUSTOMISATION_DESCRIPTION = "BBBBBBBBBB";
    ...
    public static FeatureDeployement createEntity() {
        return new FeatureDeployement()
            .code(DEFAULT_CODE)
            .customisationDescription(DEFAULT_CUSTOMISATION_DESCRIPTION)
    ...
    void getAllFeatureDeployements() throws Exception {
        ...
        restFeatureDeployementMockMvc
            ...
            .andExpect(jsonPath("$.[*].customisationDescription").value(hasItem(DEFAULT_CUSTOMISATION_DESCRIPTION)))
    ...
    void getFeatureDeployement() throws Exception {
        ...
        restFeatureDeployementMockMvc
            ...
            .andExpect(jsonPath("$.customisationDescription").value(DEFAULT_CUSTOMISATION_DESCRIPTION))
