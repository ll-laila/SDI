...
public class ClientEventTypeTestSamples {
    ...
    public static ClientEventType getClientEventTypeSample1() {
        return new ClientEventType().id(1L).type("type1").description("description1").notes("notes1");
    }

    public static ClientEventType getClientEventTypeSample2() {
        return new ClientEventType().id(2L).type("type2").description("description2").notes("notes2");
    }
