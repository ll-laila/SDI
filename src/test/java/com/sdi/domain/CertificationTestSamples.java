...
public class CertificationTestSamples {
    ...
    public static Certification getCertificationSample1() {
        return new Certification().id(1L).name("name1").description("description1").notes("notes1");
    }

    public static Certification getCertificationSample2() {
        return new Certification().id(2L).name("name2").description("description2").notes("notes2");
    }
