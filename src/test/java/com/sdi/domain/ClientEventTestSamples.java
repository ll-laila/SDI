...
public class ClientEventTestSamples {
    ...
    public static ClientEvent getClientEventSample1() {
        return new ClientEvent().id(1L).event("event1").description("description1").notes("notes1");
    }

    public static ClientEvent getClientEventSample2() {
        return new ClientEvent().id(2L).event("event2").description("description2").notes("notes2");
    }
