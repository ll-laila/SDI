...
public class ClientTypeTestSamples {
    ...
    public static ClientType getClientTypeSample1() {
        return new ClientType().id(1L).type("type1").description("description1").notes("notes1");
    }

    public static ClientType getClientTypeSample2() {
        return new ClientType().id(2L).type("type2").description("description2").notes("notes2");
    }
