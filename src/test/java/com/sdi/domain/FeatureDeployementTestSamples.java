...
public class FeatureDeployementTestSamples {
    ...
    public static FeatureDeployement getFeatureDeployementSample1() {
        return new FeatureDeployement().id(1L).code("code1").customisationDescription("customisationDescription1").notes("notes1");
    }

    public static FeatureDeployement getFeatureDeployementSample2() {
        return new FeatureDeployement().id(2L).code("code2").customisationDescription("customisationDescription2").notes("notes2");
    }
