...
public class ClientSizeTestSamples {
    ...
    public static ClientSize getClientSizeSample1() {
        return new ClientSize().id(1L).sizeName("sizeName1").sizeCode("sizeCode1").sizeDescription("sizeDescription1").notes("notes1");
    }

    public static ClientSize getClientSizeSample2() {
        return new ClientSize().id(2L).sizeName("sizeName2").sizeCode("sizeCode2").sizeDescription("sizeDescription2").notes("notes2");
    }
